...
const en = {
  ...
  loc_change: 'Change',
  loc_from_profile: 'From your profile · tap Change to use a different address',
  profile_gate_title: 'Complete your profile to sell',
  profile_gate_body: 'Buyers need to reach you. Add the missing details below to post your animal.',
  profile_gate_complete: 'Complete profile',
  profile_gate_not_now: 'Not now',
  profile_gate_browse_instead: 'Browse animals instead',
  profile_field_name: 'Your name',
  profile_field_phone: 'Phone number',
  profile_field_address: 'Address',
  sort_sheet_title: 'Sort animals',
  sort_price_low_to_high: 'Price: low to high',
  sort_price_high_to_low: 'Price: high to low',
  sort_nearest_first: 'Nearest first',
  sort_recently_listed: 'Recently listed',
  filter_sort_aria: 'Sort animals',
  filter_open_aria: 'Open filters',
  quick_filter_price_aria: 'Sort by price',
  quick_filter_nearby_aria: 'Nearby only',
  quick_filter_price_label: 'Price',
  quick_filter_nearby_label: 'Near',
  call_now: 'Call Now',
  ...
  pfs_dist_nearby_s: 'Walking distance',
  pfs_dist_5: '5 km',
  pfs_dist_10: '10 km',
  pfs_dist_15: '15 km',
  pfs_dist_20: '20 km',
  ...
  mu_replace: 'Replace',
  mu_remove: 'Remove',
  mu_current_photo: 'Current photo',
  mu_current_video: 'Current video',
  mu_file_too_large: 'File too large. Max {mb} MB.',
